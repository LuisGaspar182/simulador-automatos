...
export default function CanvasAFD({
  ...
  // Interaction refs (evitam re-render durante o arrasto)
  const panRef = useRef(null)       // toque de 1 dedo no fundo
  const pinchRef = useRef(null)     // toque de 2 dedos
  const mousePanRef = useRef(null)  // mouse no fundo
  ...
  // ── Touch: pan (1 dedo no fundo) e pinch (2 dedos) ──────────────────────
